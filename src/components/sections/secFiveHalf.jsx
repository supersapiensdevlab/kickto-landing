     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
        ...
        <div className="col-span-3 md:col-span-2 ">
          <div
            ...
            className="p-4 text-3xl font-semibold mb-4 border-gray-300 border rounded-xl   align-middle items-center col-span-2 flex-col bg-white bg-opacity-10"
          >
          ...
          <div 
            className=" p-4 text-3xl font-semibold grid grid-cols-3 border-gray-300 border rounded-xl   col-span-2  bg-white bg-opacity-10"
          >
