     ...
     function Three() {
       ...
       return (
         <div className="hero min-h-screen   text-black/80 "> <div
      data-aos="fade-right"
      data-aos-duration="500"
      data-aos-offset="400"
      data-aos-easing="ease-in-out"
      className="py-6 pb-0 text-3xl font-semibold bg-blur-pattern  border-gray-300 border rounded-xl   align-middle items-center col-span-3  md:col-span-1 flex-col bg-white bg-opacity-10"
    >
      ...
      <div className="text-base font-normal pt-4 px-6">
        ...
        your routine. Each shoe helps you earn KICKTO tokens differently. Own
        more shoes with time to grow on the platform. You can sell your old
        shoes on the same marketplace.
      </div>
      <img
        src={shoe3}
    ...
    <div className="col-span-3 md:col-span-2 ">
      <div
        ...
        data-aos-offset="400"
        data-aos-easing="ease-in-out"
        className="p-6 text-3xl font-semibold mb-4 border-gray-300 border rounded-xl mt-12 align-middle items-center col-span-2 flex-col bg-white bg-opacity-10"
      >
      ...
      <div
        ...
        data-aos-offset="200"
        data-aos-easing="ease-in-out"
        className="mt-4 sm:mt-0 p-4  text-3xl font-semibold grid grid-cols-3 border-gray-300 border rounded-xl h-full align-middle items-center col-span-2  bg-white bg-opacity-10"
      >
