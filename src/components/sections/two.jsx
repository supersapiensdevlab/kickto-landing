...
function hero() {
  return (
    ...
    data-aos-easing="ease-in-out" className="text-5xl font-bold text-primary">
    ...
    data-aos-duration="500" 
    data-aos-easing="ease-in-out" className="btn   rounded-full border-none hover:scale-95 hover:bg-primary  bg-primary md:w-max  p-4 text-white  w-full px-12">
            Get Started
          </button>
        </div>
