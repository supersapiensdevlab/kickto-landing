    ...
    <div className="hero min-h-screen bg-blur-pattern  ">
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="  grid   lg:grid-cols-3 grid-cols-1  items-center align-middle p-4">
          <h1 className="mb-5 text-5xl mt-12 sm:text-7xl font-bold col-span-1  text-black/80 sm:text-left italic">
          ...
          <div className="col-span-1 sm:text-left   lg:pl-12   ">
            <h2 className="text-3xl font-bold text-black/80">A Revolution in Fitness</h2>
